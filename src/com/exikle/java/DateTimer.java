...
public class DateTimer extends JFrame {
	...
	public DateTimer() {
		...
		credits.setText("gianpiero.francesca@yahoo.it");
		...
		Timer t = new javax.swing.Timer(1000, new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (date <= 0) {
					...
					long hour = (date % (24 * 3600 * 1000))
							/ (3600 * 1000);
					long minutes = ((date % (24 * 3600 * 1000))
							% (3600 * 1000) / (60 * 1000));
					long sec = ((date % (24 * 3600 * 1000))
							% (3600 * 1000) % (60 * 1000)) / (1000);
					countLabel.setText("Days: " + day + ", Hours: "
