...
namespace ProgrammingAssignment4 {
    ...
    public class BoardSquare {
        ...
        public BoardSquare(ContentManager contentManager, int x, int y) {
            ...
            drawRectangle.X = x - drawRectangle.Width;
            drawRectangle.Y = y - drawRectangle.Height;
        }
        ...
        public bool Update(MouseState mouse) {
            ...
            if ((drawRectangle.Contains(mouse.X, mouse.Y)) && (mouse.LeftButton == ButtonState.Pressed) && (contents == SquareContents.Empty)) {
